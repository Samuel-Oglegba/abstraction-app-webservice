...
public class AbstractionAppInitializer implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        Task task5 = createDefaultTask("Compress", 1);

        //TODO -- populate the communication --check the uniqueness of variable name
        Communication communication1 = createDefaultCommunication("REFINE_QUE", abstractType, 1);
        Communication communication2 = createDefaultCommunication("DEDUPLICATE_QUE", abstractType, 1);
        Communication communication3 = createDefaultCommunication("COMPRESS_QUE", abstractType, 1);
